...
def handle_issue_job(cfg: Config, job: Job, job_log: JobLogger) -> None:
    ...
    job_log.event("tool", "git.commit", {"message": f"Agent: address issue #{issue_number}"})
    add_all_and_commit(f"Agent: address issue #{issue_number}", workdir, _git_env(cfg))
    ...
    pr_body = textwrap.dedent(
        ...
        ## Summary
        - Automated change generated by Code Agent

        ## Testing
        - Not run locally (CI in GitHub Actions)
        """
    ).strip() + "\n"
